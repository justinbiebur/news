            ...
            ListView(
              ...
              children: <Widget>[
                  ...
                  subtitle: Column(
                    ...
                    children: <Widget>[
                      FlatButton(
                          ...
                          onPressed: () async {
                            const url = 'https://seepositive.in';
                      ...
                      FlatButton(
                          padding: EdgeInsets.all(0),
                          onPressed: () async {
                            const url = 'mailto:info@seepositive.in';
                            if (await canLaunch(url)) {
                              await launch(url);
                            } else {
                              throw 'Could not launch $url';
                ...
                InkWell(
                  onTap: () {
                    Share.share(
                        'Check out our blog: https://seepositive.in');
                  },
                  child: ListTile(
                    leading: Image.asset(
                    ...
                    title: Text('Share'),
                    subtitle: Text("Spread the words of seepositive"),
                  ),
                ),
                ListTile(
                  leading: Image.asset(
